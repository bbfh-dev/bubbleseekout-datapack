...
execute if score @s buso.check_logs matches -4 run scoreboard players set @s buso.gui_option 3
execute if score @s buso.check_logs matches -4..-1 run scoreboard players operation @s buso.check_logs = @s buso.target
